...
INCLUDE = ["PREREGISTRATION.md", "protocol.json", "Cargo.toml", "Cargo.lock", "src/main.rs", "src/canonical.rs", "src/v3.rs", "run_owalnuts.cmd", "run_numpyro.cmd",
...
GLOBS = ["fixtures/*.json", "starts/*.json", "artifacts/numpyro/*.json", "artifacts/numpyro/*.npy",
         ...
         "artifacts/*.txt", "artifacts/owalnuts-v1/preflight.json", "artifacts/owalnuts-v1/results-table.md", "artifacts/owalnuts-v1/summary.json", "artifacts/numpyro/parity.json", "artifacts/owalnuts-v*/log.txt"]
