...
FILES = ["README.md", "LEDGER-ENTRY.md", "protocol.json", "PREREGISTRATION.md", "run_joint.py", "checksums.py", "Cargo.toml", "Cargo.lock", "src/main.rs", "src/arms.rs", "src/bin/funnel.rs", "src/bin/eight_schools.rs", ".gitignore"]
