...
FILES = ["protocol.json", "PREREGISTRATION.md", "README.md", "LEDGER-ENTRY.md", "run_rescue.py", "checksums.py", "Cargo.toml", "Cargo.lock", "src/main.rs", "src/arms.rs", "src/bin/funnel.rs"]
